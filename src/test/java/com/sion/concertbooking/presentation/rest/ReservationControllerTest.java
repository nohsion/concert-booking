...
class ReservationControllerTest {
    ...
    void createReservations() throws Exception {
        ...
        List<ReservationDto> reservationDtos = List.of(
                new ReservationDto(1L, userId, concertId, concertTitle, concertScheduleId, playDateTime,
                        10L, 10, SeatGrade.VIP, 100_000, ReservationStatus.SUCCESS),
                new ReservationDto(2L, userId, concertId, concertTitle, concertScheduleId, playDateTime,
